...
class GigaChatModule(IGPTModule):
    ...
    SYSTEM_PROMPT: ClassVar[str] = (
        "Ты — эксперт-лингвист, отлично разбирающийся в словообразовании, орфографии и значении слов, включая сленг, просторечие и разговорные формы. Твоя задача — преобразовать любое данное слово или выражение в его нормативную (литературную) форму: корректное слово, в правильном числе, падеже и без искажений. Отвечай кратко, точно и по делу — только нормализованная форма слова без пояснений."
    )
